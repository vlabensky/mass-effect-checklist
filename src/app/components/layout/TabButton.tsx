...
const TabButton = ({ labelKey, onClick, isActiveTab }: Props) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`px-4 py-2 font-semibold first:rounded-t-lg md:rounded-t-lg focus:outline-none transition-colors duration-200 ease-in-out border-b-2 w-full sm:w-auto ${
        isActiveTab
