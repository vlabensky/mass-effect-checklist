...
export type TextStrings = {
  ...
  mission_me3_arrae_ex_cerberus_scientists: string;
  mission_me3_athena_nebula_hesperia_period_statue: string;
  mission_me3_citadel_batarian_codes: string;
  mission_me3_citadel_cerberus_ciphers: string;
  mission_me3_citadel_cerberus_retribution: string;
  mission_me3_citadel_cerberus_turian_poison: string;
  mission_me3_citadel_chemical_treatment: string;
  mission_me3_citadel_inspirational_stories: string;
  mission_me3_citadel_kakliosaur_fossil: string;
  mission_me3_citadel_medical_supplies: string;
  mission_me3_citadel_medi_gel_sabotage: string;
  mission_me3_citadel_reaper_code_fragments: string;
  mission_me3_citadel_shore_leave: string;
  mission_me3_citadel_target_jamming_technology: string;
  mission_me3_citadel_volus_ambassador: string;
  mission_me3_citadel_wounded_batarian: string;
  mission_me3_dekuuna_code_of_the_ancients: string;
  mission_me3_hades_nexus_obelisk_of_karza: string;
  mission_me3_hades_nexus_prothean_sphere: string;
  mission_me3_kallini_ardat_yakshi_monastery: string;
  mission_me3_citadel_asari_widow: string;
