...
const strings: TextStrings = {
  ...
  group_me3_priority_palaven: 'Priority: Palaven',
  group_me3_priority_surkesh: 'Priority: Sur\'Kesh',
  group_me3_priority_tuchanka: 'Priority: Tuchanka',
  group_me3_priority_the_citadel2: 'Priority: The Citadel II',
  group_me3_priority_geth_dreadnought: 'Priority: Geth Dreadnought',
  group_me3_priority_rannoch: 'Priority: Rannoch',
  group_me3_priority_thessia: 'Priority: Thessia',
  ...
  mission_me3_apien_crest_banner_of_the_first_regiment: 'Apien Crest: Banner of the First Regiment',
  mission_me3_aria_blood_pack: 'Aria: Blood Pack',
  mission_me3_aria_blue_suns: 'Aria: Blue Suns',
  mission_me3_aria_eclipse: 'Aria: Eclipse',
  mission_me3_benning_evidence: 'Benning: Evidence',
  mission_me3_citadel_alien_medi_gel_formula: 'Citadel: Alien Medi-Gel Formula',
  mission_me3_citadel_aria_tloak: 'Citadel: Aria T\'Loak',
  mission_me3_citadel_barla_von: 'Citadel: Barla Von',
  mission_me3_citadel_biotic_amp_interfaces: 'Citadel: Biotic Amp Interfaces',
  mission_me3_citadel_dr_bryson: 'Citadel: Dr. Bryson',
  mission_me3_citadel_gx12_thermal_pipe: 'Citadel: GX12 Thermal Pipe',
  mission_me3_citadel_hanar_diplomat: 'Citadel: Hanar Diplomat',
  mission_me3_citadel_heating_unit_stabilizers: 'Citadel: Heating Unit Stabilizers',
  mission_me3_citadel_improved_power_grid: 'Citadel: Improved Power Grid',
  mission_me3_grissom_academy_emergency_evacuation: 'Grissom Academy: Emergency Evacuation',
  ...
  mission_me3_arrae_ex_cerberus_scientists: 'Arrae: Ex-Cerberus Scientists',
  mission_me3_athena_nebula_hesperia_period_statue: 'Athena Nebula: Hesperia-Period Statue',
  mission_me3_citadel_batarian_codes: 'Citadel: Batarian Codes',
  mission_me3_citadel_cerberus_ciphers: 'Citadel: Cerberus Ciphers',
  mission_me3_citadel_cerberus_retribution: 'Citadel: Cerberus Retribution',
  mission_me3_citadel_cerberus_turian_poison: 'Citadel: Cerberus Turian Poison',
  mission_me3_citadel_chemical_treatment: 'Citadel: Chemical Treatment',
  mission_me3_citadel_inspirational_stories: 'Citadel: Inspirational Stories',
  mission_me3_citadel_kakliosaur_fossil: 'Citadel: Kakliosaur Fossil',
  mission_me3_citadel_medical_supplies: 'Citadel: Medical Supplies',
  mission_me3_citadel_medi_gel_sabotage: 'Citadel: Medi-Gel Sabotage',
  mission_me3_citadel_reaper_code_fragments: 'Citadel: Reaper Code Fragments',
  mission_me3_citadel_shore_leave: 'Citadel: Shore Leave',
  mission_me3_citadel_target_jamming_technology: 'Citadel: Target Jamming Technology',
  mission_me3_citadel_volus_ambassador: 'Citadel: Volus Ambassador',
  mission_me3_citadel_wounded_batarian: 'Citadel: Wounded Batarian',
  mission_me3_dekuuna_code_of_the_ancients: 'Dekuuna: Code of the Ancients',
  mission_me3_hades_nexus_obelisk_of_karza: 'Hades Nexus: Obelisk of Karza',
  mission_me3_hades_nexus_prothean_sphere: 'Hades Nexus: Prothean Sphere',
  mission_me3_kallini_ardat_yakshi_monastery: 'Kallini: Ardat-Yakshi Monastery',
  mission_me3_citadel_asari_widow: 'Citadel: Asari Widow',
